...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='teacher',
            name='subjects',
            field=models.ManyToManyField(through='testapp.TeachersToSubjects', to='testapp.subject'),
        ),
        migrations.AddField(
            model_name='teacher',
            name='user_id',
        ...
        migrations.AddField(
            model_name='subject',
            name='teachers',
            field=models.ManyToManyField(through='testapp.TeachersToSubjects', to='testapp.teacher'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
